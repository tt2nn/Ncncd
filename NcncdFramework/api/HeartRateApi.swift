...
public class HeartRateApi: NSObject {
    ...
    ///   - data: 心率数据
    ///   - telephone: 电话
    public static func uploadHeartRate(data: Array<HeartRate>, telephone: String){
        ...
        request.data = HeartRate.mj_keyValuesArray(withObjectArray: data).mj_JSONString()
        ...
        // 上传心率
        HttpSession.sendPost(url: URL_PATH_DATA_UPLOAD_HEART_RATE, parameters: request.mj_keyValues(), httpCallBack: HttpHandler())
