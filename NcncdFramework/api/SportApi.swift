...
public class SportApi: NSObject {
    ...
    ///   - data: 运动数据
    ///   - telephone: 电话
    public static func uploadSport(data: Array<Sport>, telephone: String){
        ...
        request.data = Sport.mj_keyValuesArray(withObjectArray: data).mj_JSONString()
        ...
        // 上传运动
        HttpSession.sendPost(url: URL_PATH_DATA_UPLOAD_SPORT, parameters: request.mj_keyValues(), httpCallBack: HttpHandler())
