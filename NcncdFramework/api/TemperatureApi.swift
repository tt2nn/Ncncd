...
public class TemperatureApi: NSObject {
    ...
    ///   - data: 体温数据
    ///   - telephone: 电话
    public static func uploadTemperature(data: Array<Temperature>, telephone: String){
        ...
        request.data = Temperature.mj_keyValuesArray(withObjectArray: data).mj_JSONString()
        ...
        // 上传体温
        HttpSession.sendPost(url: URL_PATH_DATA_UPLOAD_TEMPERATURE, parameters: request.mj_keyValues(), httpCallBack: HttpHandler())
