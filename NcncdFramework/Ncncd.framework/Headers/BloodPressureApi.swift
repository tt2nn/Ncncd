...
public class BloodPressureApi: NSObject {
    ...
    ///   - data: 血压数据
    ///   - telephone: 电话
    public static func uploadBloodPressure(data: Array<BloodPressure>, telephone: String){
        ...
        request.data = BloodPressure.mj_keyValuesArray(withObjectArray: data).mj_JSONString()
        ...
        // 上传血压
        HttpSession.sendPost(url: URL_PATH_DATA_UPLOAD_BLOOD_PRESSURE, parameters: request.mj_keyValues(), httpCallBack: HttpHandler())
